        ...
        <div className="col-sm-12 col-lg-5 ">
          <div className="card m-1 shadow-lg p-3 mb-5 bg-body rounded">
            <div className="card-body ">
              <h2 className="welcome-text text-center shadow-text">
                My Projects!
              </h2>
            </div>
          </div>
        ...
        <div className="card m-5 col-sm-12 col-lg-6 shadow-lg p-3 mb-5 bg-body rounded ">
          ...
          <div className="card-body">
            ...
            <ul className="card-text">
              ...
              <li>Advance Css:</li>
              <li>
                Media Query, Flexbox, Advance Box Styling, CSS Selectors,
                Responsive Design
              </li>
            </ul>
          </div>
        ...
        <div className="card m-5 col-sm-10  col-lg-6 shadow-lg p-3 mb-5 bg-body rounded">
          ...
          <div className="card-body">
            ...
            <ul className="card-text">
              ...
              <li>CSS</li>
              <li>
                JavaScript, Media Query, Flexbox, Advance Box Styling, CSS
                Selectors, Responsive Design
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="card m-5 col-sm-10  col-lg-6 shadow-lg p-3 mb-5 bg-body rounded">
          ...
          <div className="card-body">
            ...
            <ul className="card-text">
              ...
              <li>CSS</li>
              <li>
                JavaScript, Scripts, Variables, Arrays, Methods, Objects,
                Iterations, Functions, Scoping
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="card m-5 col-sm-10  col-lg-6 shadow-lg p-3 mb-5 bg-body rounded">
          ...
          <div className="card-body">
            ...
            <ul className="card-text">
              ...
              <li>CSS</li>
              <li>
                Javascript, Handlebars, Middleware, REST, Cookies, NodeJS, OOP,
                Express, SQL, ORM, MVC, Modularization, NPM, Inquirer, Arrow
                Functions, Asyncrhonous JavaScript,{" "}
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="card m-5 col-sm-10  col-lg-6 shadow-lg p-3 mb-5 bg-body rounded">
          ...
          <div className="card-body">
            ...
            <ul className="card-text">
              ...
              <li>CSS</li>
              <li>
                JavaScript, NoSQL, MongoDB, Object-document mapping,
                Mongoose.js, CRUD
              </li>
            </ul>
          </div>
